...
export function ChartPanel({ data, chartUpdateIntervalSec = 1, onChartUpdateIntervalChange, dataKey, useLineGraph = true, graphElementSize, enableLineDot, meanData = null, enableYAxisAutoScale }) {
