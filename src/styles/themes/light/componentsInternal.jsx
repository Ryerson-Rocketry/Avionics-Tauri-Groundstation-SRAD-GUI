...
function computeButtonStyle({
  ...
  const resolvedTextColor = textColor || (variant === 'solid' ? '#FFF' : outlineColor);
  const hoverBg =
    hoverBackgroundColor ||
    (variant === 'solid'
      ? rgbaFrom(outlineColor, 0.9) || 'rgba(0,0,0,0.08)'
      : rgbaFrom(outlineColor, 0.1) || 'rgba(0,0,0,0.04)');

  const baseBg =
    backgroundColor ||
    (variant === 'gradient'
      ? `linear-gradient(135deg, ${rgbaFrom(outlineColor, 0.15)}, ${rgbaFrom(outlineColor, 0.02)})`
      : variant === 'solid'
        ? outlineColor
        : 'transparent');
  ...
  return {
    ...
    color: disabled ? '#cbd5e1' : resolvedTextColor,
    border,
    cursor: disabled ? 'not-allowed' : 'pointer',
    transition: 'all 0.2s ease',
    boxShadow: glow ? `0 4px 12px ${rgbaFrom(outlineColor, 0.25)}` : undefined,
...
export const uiStyles = {
  app: {
    wrapper: { margin: 0, padding: 0, width: '100vw', height: '100vh', overflow: 'hidden', backgroundColor: '#F8FAFC' },
    text: { color: '#1e293b' },
  },
  ...
  backgroundEffect: {
    ...
    star: (s) => ({
      ...
      borderRadius: '50%',
      boxShadow: `0 0 ${parseInt(s.size, 10) * 2}px #38BDF8`,
    ...
    ship: {
      ...
      width: '180px',
      height: '2px',
      background: 'linear-gradient(90deg, transparent, #0EA5E9, #38BDF8)',
  ...
  settings: {
    ...
    loadingText: { color: '#0EA5E9', fontFamily: ui.font.mono, letterSpacing: '2px' },
  },
  ...
  telemetryDataField: {
    ...
    label: { fontSize: ui.text.xs, color: '#0EA5E9', letterSpacing: '1px' },
    input: {
      ...shared.inputBase,
      padding: '0.9vh 0.9vw',
    },
  ...
  newMission: {
    ...
    select: {
      ...
      MozAppearance: 'none',
      backgroundImage:
        'linear-gradient(45deg, transparent 50%, rgba(100,116,139,0.7) 50%), linear-gradient(135deg, rgba(100,116,139,0.7) 50%, transparent 50%)',
